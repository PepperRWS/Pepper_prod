...
class DecosRatingService:
    ...
    def get_ratings(self):
        try:
            file = open("/home/nao/.local/share/analytics.txt", "r")
            return file.read()
        except:
            return None

    def remove_ratings(self):
        open("/home/nao/.local/share/analytics.txt", 'w').close()
...
if __name__ == "__main__":
    ...
    app.start()
    service_instance = DecosRatingService(app)
